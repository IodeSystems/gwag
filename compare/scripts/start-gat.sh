...
#
# `start` boots compare/cmd/gat-gateway on :18080 (the port
...
#
# gwag and gat both want :18080, and the orchestrator runs gateways
# serially, so only one is ever up at a time.
set -euo pipefail
