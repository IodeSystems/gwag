...
package gatbenchv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/iodesystems/gwag/compare/gatbench/connectimpl/gen/gatbench/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProjectServiceName = "gatbench.v1.ProjectService"
)
...
const (
	...
	// RPC.
	ProjectServiceGetProjectProcedure = "/gatbench.v1.ProjectService/GetProject"
	// ProjectServiceListProjectsProcedure is the fully-qualified name of the ProjectService's
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/gatbench.v1.ProjectService/ListProjects"
)

// ProjectServiceClient is a client for the gatbench.v1.ProjectService service.
type ProjectServiceClient interface {
	GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error)
	ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error)
}

// NewProjectServiceClient constructs a client for the gatbench.v1.ProjectService service. By
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_gatbench_v1_gatbench_proto.Services().ByName("ProjectService").Methods()
...
// GetProject calls gatbench.v1.ProjectService.GetProject.
...
// ListProjects calls gatbench.v1.ProjectService.ListProjects.
...
// ProjectServiceHandler is an implementation of the gatbench.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gatbench.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gatbench.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gatbench.v1.ProjectService.ListProjects is not implemented"))
}
