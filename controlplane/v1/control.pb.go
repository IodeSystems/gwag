...
const file_controlplane_v1_control_proto_rawDesc = "" +
	"\n" +
	"\x1dcontrolplane/v1/control.proto\x12\x17gateway.controlplane.v1\"\xac\x01\n" +
	...
	"\x15SignSubscriptionToken\x125.gateway.controlplane.v1.SignSubscriptionTokenRequest\x1a6.gateway.controlplane.v1.SignSubscriptionTokenResponseBFZDgithub.com/iodesystems/go-api-gateway/controlplane/v1;controlplanev1b\x06proto3"

var (
	file_controlplane_v1_control_proto_rawDescOnce sync.Once
	file_controlplane_v1_control_proto_rawDescData []byte
)

func file_controlplane_v1_control_proto_rawDescGZIP() []byte {
	file_controlplane_v1_control_proto_rawDescOnce.Do(func() {
		file_controlplane_v1_control_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_controlplane_v1_control_proto_rawDesc), len(file_controlplane_v1_control_proto_rawDesc)))
	})
...
var file_controlplane_v1_control_proto_goTypes = []any{
...
func file_controlplane_v1_control_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_controlplane_v1_control_proto_rawDesc), len(file_controlplane_v1_control_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   1,
